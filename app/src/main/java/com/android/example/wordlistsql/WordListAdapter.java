...
import static com.android.example.wordlistsql.db.WordListOpenHelper.KEY_WORD;
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        ...
        holder.delete_button.setOnClickListener(new MyButtonOnClickListener(
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(String.valueOf(current.getId()), holder.getAbsoluteAdapterPosition());
